Caches git graph produced by [jandee.vercel.app](https://jandee.vercel.app/), with some styling modifications, ready to be used in an `<embed>` or `<iframe>` element with minimal rendering overhead.
